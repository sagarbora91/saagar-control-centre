...
test('MAH-3 Planning canary evidence binds all 12 browser cases without device overclaim', () => {
  ...
  const legacyCss = fs.readFileSync(path.join(root, 'tests', 'fixtures', 'phase6c', 'module-mobile-legacy.css'), 'utf8');
