...
(function(root,factory){var api=factory(root);if(typeof module==='object'&&module.exports)module.exports=api;if(root)root.SaagarEtpImportRuntimeFactory=api;})(typeof globalThis!=='undefined'?globalThis:this,function(root){
  ...
  function create(options){
    ...
    if(!profile||!profileAuthority||typeof profileAuthority.authorize!=='function'||!loader||(!workerParser&&options.testOnlySynchronousParser!==true)||!lifecycle||!coordinatorApi||!nativeApi||!reconciliation||!core||!registryApi||!readerApi||profile.VERSION!==core.ETP_CORE_VERSION||profile.VERSION!==profileAuthority.PROFILE_VERSION)return failure('ETP_RUNTIME_DEPENDENCY_INVALID','CREATE');
    ...
    var preparedFiles=null,parsedReports=null,pending=null,authorityBinding=null;
    var pipeline={
      ...
      validate:async function(value){
        ...
        manifest.authority=authorityBinding;
